...
function HomeContent() {
  ...
  useEffect(() => {
    ...
    // Auto-open review mode if ?review=true is in URL
        ...
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 bg-white rounded-xl shadow-sm border border-gray-200 text-gray-600 hover:text-bloom-600 hover:border-bloom-200 transition-all"
              title="API Settings"
            >
